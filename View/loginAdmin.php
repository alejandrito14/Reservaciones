...
<html lang="en">
    <head>
        ...
        <title>Tres lagunas |Administrador logeo </title>
        ...
        <!-- Custom Theme Style -->
        <link href="../Resource/build/css/custom_1.css" rel="stylesheet">
    </head>
        ...
        <header>
            ...
            <center>
                <ul class="center-align black-text">
                    <h3>Centro Ecoturístico Tres Lagunas </h3>
            ...
            <div class="animate form login_form">
                <section class="login_content">
                    <form id="formingreso" name="formingreso" method="POST">
                        ...
                        <div>
                            <button id="btningreso" type="submit" class="btn btn-success btn-block"   >INGRESAR</button>                
